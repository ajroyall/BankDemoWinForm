...
-- Run this script after zbnkcust.sql
...
CREATE TABLE BNKACC
(
    BAC_PID                   CHAR(5) NOT NULL REFERENCES BNKCUST(BCS_PID),
    BAC_ACCNO                 CHAR(9) NOT NULL PRIMARY KEY,
    BAC_ACCTYPE               CHAR(1) NOT NULL REFERENCES BNKATYPE(BAT_TYPE),
    BAC_BALANCE               DECIMAL(9,2) NOT NULL  DEFAULT 0,
    BAC_LAST_STMT_DTE         DATE NOT NULL  DEFAULT GETDATE(),
    BAC_LAST_STMT_BAL         DECIMAL(9,2) NOT NULL DEFAULT 0,
    BAC_ATM_ENABLED           CHAR(2) NOT NULL DEFAULT '  ',
    BAC_ATM_DAY_LIMIT         DECIMAL(3,0) DEFAULT 0,
    BAC_ATM_DAY_DTE           DATE DEFAULT GETDATE(),
    BAC_ATM_DAY_AMT           DECIMAL(3,0) DEFAULT 0,
    BAC_RP1_DAY               CHAR(2) DEFAULT '  ',
    BAC_RP1_AMOUNT            DECIMAL(7,2) DEFAULT 0,
    BAC_RP1_PID               CHAR(5) DEFAULT '     ',
    BAC_RP1_ACCNO             CHAR(9) DEFAULT '         ',
    BAC_RP1_LAST_PAY          DATE DEFAULT GETDATE(),
    BAC_RP2_DAY               CHAR(2) DEFAULT '  ',
    BAC_RP2_AMOUNT            DECIMAL(7,2) DEFAULT 0,
    BAC_RP2_PID               CHAR(5) DEFAULT '     ',
    BAC_RP2_ACCNO             CHAR(9) DEFAULT '         ',
    BAC_RP2_LAST_PAY          DATE DEFAULT GETDATE(),
    BAC_RP3_DAY               CHAR(2) DEFAULT '  ',
    BAC_RP3_AMOUNT            DECIMAL(7,2) DEFAULT 0,
    BAC_RP3_PID               CHAR(5) DEFAULT '     ',
    BAC_RP3_ACCNO             CHAR(9) DEFAULT '         ',
    BAC_RP3_LAST_PAY          DATE DEFAULT GETDATE(),
    BAC_FILLER                CHAR(59) DEFAULT '                                                          ',
